...
class SignUpScreenForDriver extends StatelessWidget {
  const SignUpScreenForDriver({super.key});
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                        Navigator.pushReplacementNamed(context, AppRoutes.SignInScreenForDriver);
                      },
                      child: Text(
                        "Login",
                        style: TextStyle(
